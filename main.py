...
def main(mod_api, nsfw_api, report_api):
    ...
    for post in posts.mod:
        did_images.setdefault(post.author, [])
        did_images[post.author].extend(post.imgUrls.split(','))
...
if __name__ == '__main__':
    ...
    main(args.get_mod_api, args.update_nsfw_api, args.get_report_nsfw_api)
